...
public class DtClaseWS {
	...
	public DtClaseWS() { }
	public DtClaseWS(DtClaseExtra c) {
		int i=0;
	...
	public DtClaseExtra adapt() {
		...
		return new DtClaseExtra(this.getNombre(),this.getNicknameProfesor(),this.getCorreoProfesor(), minSocios, maxSocios,urlwebsite, fechaClase.adapt(), fechaRegistro.adapt(),   
