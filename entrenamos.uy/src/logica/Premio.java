...
public class Premio {
	...
	private DtFechaHora fechaSorteo = new DtFechaHora(0,0,0,0,0,0);
	...
	Premio(Clase  classss ,  String  desc,  int  cant, boolean real, DtFechaHora fechaSorteo2){
		description = desc;
		cantidad = cant;
		classroom = classss;
		realizado = real;
