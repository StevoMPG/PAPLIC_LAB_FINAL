...
public class ModificarDatosUsuario extends JInternalFrame {
	...
	public ModificarDatosUsuario(IcontroladorUsuario iUC) {
		...
		comboBoxUsuario.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				...
				if (comboBoxUsuario.getSelectedIndex() > 0) {
					...
					try {
						datosUsuarioActual = iUC.seleccionarUsuario(nickUsuario);
	...
	private int tomarDatos() {
		...
		if (tipoDeUsuario.contains("Profesor")) {
			...
			datosUser = new DtProfesor(nicknameU, nombreU, apellidoU, emailU,  datosUsuarioActual.getContrasenia(), new DtFechaHora(anioU, mesU, diaU, 0, 0, 0), institucionU,  descripcionU, biografiaU, websiteU, datosUsuarioActual.getImagen());
		}
		else //Se asume que si no es profesor es socio
		{
			datosUser = new DtSocio(nicknameU, nombreU, apellidoU, emailU, datosUsuarioActual.getContrasenia(), new DtFechaHora(anioU, mesU, diaU, 0, 0, 0), datosUsuarioActual.getImagen());
		}
