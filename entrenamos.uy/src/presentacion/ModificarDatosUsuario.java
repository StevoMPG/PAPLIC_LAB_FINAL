...
public class ModificarDatosUsuario extends JInternalFrame {
	...
	private int tomarDatos() {
		...
		if (tipoDeUsuario.contains("Profesor")) {
			...
			datosUser = new DtProfesor(nicknameU, nombreU, apellidoU, emailU, new DtFechaHora(anioU, mesU, diaU, 0, 0, 0), institucionU,  descripcionU, biografiaU, websiteU, datosUsuarioActual.getImagen());
		}
		else //Se asume que si no es profesor es socio
		{
			datosUser = new DtSocio(nicknameU, nombreU, apellidoU, emailU, new DtFechaHora(anioU, mesU, diaU, 0, 0, 0), datosUsuarioActual.getImagen());
		}
