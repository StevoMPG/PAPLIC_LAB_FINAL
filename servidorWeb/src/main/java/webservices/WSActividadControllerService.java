 ...
 * 
 */
@WebServiceClient(name = "WSActividadControllerService", targetNamespace = "http://webServices/", wsdlLocation = "http://localhost:9129/entrenamosuy/actividadController?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSACTIVIDADCONTROLLERSERVICE_QNAME = new QName("http://webServices/", "WSActividadControllerService");
    ...
    public WSActividadController getWSActividadControllerPort() {
        return super.getPort(new QName("http://webServices/", "WSActividadControllerPort"), WSActividadController.class);
    }
    ...
    public WSActividadController getWSActividadControllerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webServices/", "WSActividadControllerPort"), WSActividadController.class, features);
    }
